...
public class ViewByDate extends Activity{
	...
	LinearLayout gridviewlinearLayout,anyChart2LinearLayout,view_by_dateLinearLayout;
	Button viewMoreInfo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.view_by_date);
		init();
		...
		selectDateTextView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				DatePickerDialog datePickerDialog = new DatePickerDialog(
						ViewByDate.this, new DatePickerDialog.OnDateSetListener() {
							@Override
		...
		gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
	            ...
	            AlertDialog.Builder dialog = new AlertDialog.Builder(ViewByDate.this);
		...
		viewMoreInfo.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				buffer.append("Highest Expenses: ₱"+higest+"\n");
				buffer.append("Lowest Expenses: ₱"+lowest+"\n");
				buffer.append("Total Expenses: ₱"+sum+"\n");
				buffer.append("Average Expenses: ₱"+average+"\n");
				buffer.append("Mean: ₱"+average+"\n");
				buffer.append("Median: ₱"+median+"\n");
				buffer.append("Range: ₱"+range+"\n");
				buffer.append("Your Array: "+Arrays.toString(values)+"\n");
				androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(new ContextThemeWrapper(ViewByDate.this, R.style.AlertDialogCustom));
	...
	public void init() {
		...
		view_by_dateLinearLayout = (LinearLayout) findViewById(R.id.view_by_dateLinearLayout);
 	}
}